                        ...
                        <div class="shadow overflow-hidden border-b border-gray-200 sm:rounded-lg">
                            ...
                            @method('PUT')
                                ...
                                <div class="mt-4">
                                    ...
                                    <x-jet-input id="course_title" class="block mt-1 w-full" type="text" name="course_title" value="{{$course->course_title}}" required autofocus autocomplete="course_title" />
                                ...
                                <div class="mt-4">
                                    ...
                                    <x-jet-input id="course_description" class="block mt-1 w-full" type="text" name="course_description" value="{{$course->course_description}}" required />
                                ...
                                <div class="mt-4">
                                    ...
                                    <select name="course_category" id="course_category" class="block mt-1 w-full border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm">
                                        <option value="education" {{($course->course_category === 'education') ? 'Selected': ''}} > Education </option>
                                        <option value="exercise" {{($course->course_category === 'exercise') ? 'Selected': ''}} > Exercise </option>
                                    </select>
                                </div>
                                ...
                                <div class="mt-4 ">
                                    ...
                                    <select name="course_type" id="course_type" class="block mt-1 w-full border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm">
                                        ...
                                        <option value="prime" {{($course->course_type === 'prime') ? 'Selected': ''}} > Prime </option>
                                    </select>
                                </div>
                                ...
                                <div class="mt-4">
                                    ...
                                    <x-jet-input id="course_cost" class="block mt-1 w-full" type="text" name="course_cost" value="{{$course->course_cost}}" required />
                                ...
                                <div class="mt-4">
                                    ...
                                    <x-jet-input id="course_duration" class="block mt-1 w-full" type="text" name="course_duration" value="{{$course->course_duration}}" required />
                                ...
                                <div class="mt-4">
                                    ...
                                    <x-jet-input id="sets" class="block mt-1 w-full" type="text" name="sets" value="{{$course->sets}}"  />
                                ...
                                <div class="mt-4">
                                    ...
                                    <x-jet-input id="reps" class="block mt-1 w-full" type="text" name="reps" value="{{$course->reps}}"  />
